...
\begin{itemize}
    ...
    \item \textbf{Nombre del hallazgo/resultado:}  Asociación entre ambas variables, superficie de la vía y condiciones de luz.
    ...
    la prueba de Chi-Cuadrado con p valor de 2.12*10ˆ16 lo cual indica que hay una relación 
...
\begin{table}[htbp]
  ...
  \small % Reducimos ligeramente el tamaño de letra para que calce perfectamente en la página
  \begin{tabular}{llc}
    \toprule
...
\begin{itemize}
    ...
    Al encontrar tres diferentes combinaciones que afectan la frecuencia ya es ganancia para poder entender cuales son 
