...
\begin{itemize}
	...
	\item \textbf{Contraste con otra fuente:}  El contraste entre Yannis et al
	 y la literatura de Ismael y 
	Razzaq se basa en cómo analizan la seguridad en los 
	cruces de calles. La conclusión principal según \cite{yannis_effectiveness_junctions} 
	...
	el campo. Por otro lado, la investigación de Ismael y Razzaq \cite{KARZAN2017} 
	...
	esté resbaladiza y los frenos no respondan igual. En resumen, mientras Yannis 
	et al. \cite{yannis_effectiveness_junctions} prueban que cambiar semáforos por 
	rotondas tiende a ser más beneficioso, Ismael y Razzaq \cite{KARZAN2017} explican 
