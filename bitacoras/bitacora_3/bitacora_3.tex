...
\begin{itemize}
    \item \textbf{Conexión con mi proyecto:}  Este documento se conecta de manera directa con la pregunta de investigación sobre patrones de accidentes en el Reino Unido (2010-2017). El texto válida el uso que se quiere hacer de la variable Junction_Detail, ya que analiza específicamente cómo cambia el riesgo al segregar flujos en rotondas y cruces. Además, se asocia con la variable Special_Conditions_at_Site, dado que fundamentan cómo influye la presencia, ausencia o el correcto funcionamiento de los semáforos e infraestructura de señalización en la frecuencia de los accidentes. Las tablas de frecuencia, la prueba de Chi-cuadrado y el análisis de residuos que se realizarán permitirán comprobar si los patrones empíricos observados en el Reino Unido coinciden con las reducciones de siniestralidad descritas en la literatura de este informe.\\
...
\addcontentsline{toc}{subsubsection}{Residuos de la condición de superficie y luz}
\begin{figure}[H]
    \centering
...
\begin{table}[htbp]
  \centering
  \caption{Residuos estandarizados de la prueba de independencia entre superficie de la vía y condición de luz (orden descendente).}
  \label{tab:residuos_luz_superficie}
  \small 
  \begin{tabular}{llc}
    \toprule
    \textbf{Superficie de la Carretera} & \textbf{Condición de Luminosidad} & \textbf{Residuo Estandarizado} \\ 
    \midrule
    Seca & Luz del día & 218.97 \\
    Húmeda o mojada & Oscuridad con luces & 156.62 \\
    Húmeda o mojada & Oscuridad sin iluminación & 114.65 \\
    Escarcha o hielo & Oscuridad sin iluminación & 90.28 \\
    Inundación $>$ 3cm & Oscuridad sin iluminación & 44.39 \\
    Nieve & Oscuridad sin iluminación & 39.09 \\
    Húmeda o mojada & Oscuridad sin luces & 26.20 \\
    Escarcha o hielo & Oscuridad con luces & 11.75 \\
    Nieve & Oscuridad con luces & 8.97 \\
    Escarcha o hielo & Oscuridad (iluminación desconocida) & 4.97 \\
    Seca & Oscuridad (iluminación desconocida) & 4.06 \\
    Inundación $>$ 3cm & Oscuridad sin luces & 3.87 \\
    Escarcha o hielo & Oscuridad sin luces & 2.91 \\
    \midrule
    Inundación $>$ 3cm & Oscuridad con luces & -4.47 \\
    Húmeda o mojada & Oscuridad (iluminación desconocida) & -6.03 \\
    Inundación $>$ 3cm & Luz del día & -19.06 \\
    Seca & Oscuridad sin luces & -26.88 \\
    Nieve & Luz del día & -28.17 \\
    Escarcha o hielo & Luz del día & -57.61 \\
    Seca & Oscuridad sin iluminación & -149.72 \\
    Seca & Oscuridad con luces & -156.71 \\
    Húmeda o mojada & Luz del día & -200.67 \\
    \bottomrule
  \end{tabular}
\end{table}
\end{itemize}
...
\addcontentsline{toc}{subsubsection}{Residuos del día de la semana y zona}
\begin{figure}[H]
    \centering
...
\begin{table}[htbp]
  \centering
  \caption{Residuos estandarizados de la prueba de independencia entre el día de la semana y la zona del accidente.}
  \label{tab:residuos_dia_zona}
  \begin{tabular}{llc}
    \toprule
    \textbf{Día de la Semana} & \textbf{Zona Geográfica} & \textbf{Residuo Estandarizado} \\ 
    \midrule
    Domingo & Rural & 43.34 \\
    Miércoles & Urbano & 12.65 \\
    Martes & Urbano & 11.81 \\
    Jueves & Urbano & 11.44 \\
    Sábado & Rural & 7.83 \\
    Viernes & Urbano & 6.64 \\
    ...
    Jueves & Rural & -11.44 \\
    Martes & Rural & -11.81 \\
    Miércoles & Rural & -12.65 \\
    Domingo & Urbano & -43.34 \\
    \bottomrule
  \end{tabular}
\end{table}
