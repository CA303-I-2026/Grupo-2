...
\begin{itemize}
	...
	\item \textbf{Contraste con otra fuente:}  El contraste entre Yannis et al. y 
	la literatura de Ismael y Razzaq se basa en cómo analizan la seguridad en los 
	cruces de calles. La conclusión principal de Yannis et al es que los aunque los 
	semáforos sí reducen siniestralidad, estos no siempre son la opción más segura. 
	De hecho, demuestran que las intersecciones con semáforos tienen muchos más 
	accidentes con heridos que las rotondas. Según sus datos, si se quitan los 
	semáforos y se construye una rotonda, los accidentes con lesionados bajan entre 
	un 11\% y un 17\% en las ciudades, y hasta un 75\% en el campo. 
Por otro lado, la investigación de Ismael y Razzaq ayuda a entender por qué 
ocurren estos accidentes desde el punto de vista del conductor y del clima, 
algo que el primer estudio no explica. Ellos señalan que los semáforos forman 
filas de vehículos esperando el cambio de luz. Si el semáforo está cerca de una 
curva o en una calle donde se viaja rápido, el riesgo de que un auto choque por 
detrás a otro es muy alto. Este peligro se vuelve mucho peor cuando llueve, ya 
que el agua hace que la carretera esté resbaladiza y los frenos no respondan 
igual. En resumen, mientras Yannis et al. prueban que cambiar semáforos por r
otondas tiende a ser más beneficioso, Ismael y Razzaq explican la razón: los 
semáforos fallan porque obligan a frenar en seco en situaciones donde el clima 
o la velocidad hacen que sea casi imposible detener el auto a tiempo.
