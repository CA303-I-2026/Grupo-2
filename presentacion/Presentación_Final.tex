...
\begin{frame}[plain]
  ...
  \begin{columns}[T]
    ...
    \begin{column}{0.5\textwidth}
      \begin{itemize}
\item Rural: pico en la mañana (neblina, sol fuerte, lluvia matutina, rutina agrícola/laboral temprana).
\item Urbano: pico en la noche (ocio, salida laboral, poca visibilidad).
\item Hosseinian y Torghabeh (2012): los picos de siniestralidad se alinean con las rutinas sociales, no con el clima o infraestructura.
\item Limitación de la fuente: bloques horarios grandes no capturan picos finos de congestión (horas pico exactas).
        \end{itemize}
    \end{column}
\end{columns}
\end{frame}
